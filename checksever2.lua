...
local function createGuiForPlayer(player)
	...
	frame.Size = UDim2.new(0, 260, 0, 92)
	...
	uptimeLabel.Font = Enum.Font.RobotoBold
	...
	sub.Position = UDim2.new(0, 10, 0, 68)
	sub.BackgroundTransparency = 1
	sub.Text = "Đang theo dõi thời gian server..."
	sub.TextColor3 = Color3.fromRGB(180, 180, 180)
	sub.TextSize = 12
	sub.Font = Enum.Font.Roboto
...
task.spawn(function()
	while task.wait(10) do
		local uptime = getServerUptime()
		if uptime then
			print("Server online: " .. formatTime(uptime))
		end
	end
end)
